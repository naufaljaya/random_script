...
DATA_ALL_DIR = "/content/dataset/raw"

DATA_OUT_DIR = "/content/dataset"
...
train_bboxes_filename = '/content/oidv6-train-annotations-bbox.csv'
validation_bboxes_filename = '/content/validation-annotations-bbox.csv'
test_bboxes_filename = '/content/test-annotations-bbox.csv'
